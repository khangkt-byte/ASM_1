...
namespace ASM_1.Areas.Admin.Controllers
{
    ...
    public class DiscountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DiscountId,Code,Percent,MaxAmount,StartDate,EndDate,IsActive")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiscountId,Code,Percent,MaxAmount,StartDate,EndDate,IsActive")] Discount discount)
        {
